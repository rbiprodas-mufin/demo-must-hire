...
"[project]/src/pages-components/jobs/details.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function JobDetails() {
    ...
    const handleApply = ()=>{
        ...
        if (!isLoggedIn) {
            ...
            router.push("/login?redirect=/apply/".concat(jobId));
        } else {
...
_s(JobDetails, "WpY6GPspzCxdcY5a18dlCS2Lu4c=", false, function() {
    return [
...
//# sourceMappingURL=src_1294cbc6._.js.map