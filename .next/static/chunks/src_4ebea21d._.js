...
function JobsPage() {
    ...
    const filteredJobs = jobsData.filter((job)=>{
        var _filters_search, _filters_location, _filters_type, _filters_status, _filters_department, _job_requirements, _job_status, _job_department;
        const searchTerm = (_filters_search = filters.search) === null || _filters_search === void 0 ? void 0 : _filters_search.toLowerCase().trim();
        const locationFilter = (_filters_location = filters.location) === null || _filters_location === void 0 ? void 0 : _filters_location.toLowerCase();
        const typeFilter = (_filters_type = filters.type) === null || _filters_type === void 0 ? void 0 : _filters_type.toLowerCase();
        const statusFilter = (_filters_status = filters.status) === null || _filters_status === void 0 ? void 0 : _filters_status.toLowerCase();
        const departmentFilter = (_filters_department = filters.department) === null || _filters_department === void 0 ? void 0 : _filters_department.toLowerCase();
        const matchSearch = !searchTerm || job.title.toLowerCase().includes(searchTerm) || ((_job_requirements = job.requirements) === null || _job_requirements === void 0 ? void 0 : _job_requirements.some((skill)=>skill.toLowerCase().includes(searchTerm)));
        ...
        const matchStatus = !statusFilter || ((_job_status = job.status) === null || _job_status === void 0 ? void 0 : _job_status.toLowerCase()) === statusFilter;
        const matchDepartment = !departmentFilter || ((_job_department = job.department) === null || _job_department === void 0 ? void 0 : _job_department.toLowerCase()) === departmentFilter;
        return matchSearch && matchLocation && matchType && matchStatus && matchDepartment;
    });
    console.log("Filtered Jobs:", filteredJobs);
    var _filters_status, _filters_location, _filters_department;
    const filtersOptions = [
        ...
        {
            label: "Department",
            value: (_filters_department = filters.department) !== null && _filters_department !== void 0 ? _filters_department : "all",
            onChange: (val)=>setFilters((prev)=>({
                        ...prev,
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                                                href: "/admin/jobs/".concat(job.id, "?type=edit"),
                                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                                    variant: "outline",
                                                                                    size: "sm",
                                                                                    children: [
...
_s(JobsPage, "FvdzFsiy4oKGozZdRh9MBwNfrYU=", false, function() {
    return [
...
//# sourceMappingURL=src_4ebea21d._.js.map