...
function JobsPage() {
    _s();
    const [filteredJobs, setFilteredJobs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(jobs);
        ...
        "JobsPage.useEffect": ()=>{
            ...
            if (searchTerm) {
                filtered = filtered.filter({
                    "JobsPage.useEffect": (job)=>job.title.toLowerCase().includes(searchTerm.toLowerCase()) || job.company.toLowerCase().includes(searchTerm.toLowerCase()) || job.skills.some({
                            "JobsPage.useEffect": (skill)=>skill.toLowerCase().includes(searchTerm.toLowerCase())
                        }["JobsPage.useEffect"])
                }["JobsPage.useEffect"]);
            }
            if (locationFilter && locationFilter !== "all") {
                filtered = filtered.filter({
                    "JobsPage.useEffect": (job)=>job.location.toLowerCase().includes(locationFilter.toLowerCase())
                }["JobsPage.useEffect"]);
            }
            if (typeFilter && typeFilter !== "all") {
                filtered = filtered.filter({
                    "JobsPage.useEffect": (job)=>job.type === typeFilter
                }["JobsPage.useEffect"]);
            }
...
_s(JobsPage, "i0HLwQHSIkkS9WHHV+py8MD58VI=", false, function() {
    return [
...
//# sourceMappingURL=src_6c1ee466._.js.map