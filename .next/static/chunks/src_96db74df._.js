...
function UsersPage() {
    ...
    const search = (searchTerm === null || searchTerm === void 0 ? void 0 : searchTerm.trim().toLowerCase()) || "";
    const filteredUsers = usersData.filter((user)=>{
        var _user_name, _user_email, _user_role, _user_status;
        const name = ((_user_name = user.name) === null || _user_name === void 0 ? void 0 : _user_name.toLowerCase()) || "";
        ...
        const status = ((_user_status = user.status) === null || _user_status === void 0 ? void 0 : _user_status.toLowerCase()) || "";
...
_s(UsersPage, "OmDgK203oDAowjjgtrKL/iRh090=", false, function() {
    return [
...
//# sourceMappingURL=src_96db74df._.js.map